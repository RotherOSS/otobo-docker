...
Usage:
    ...
    $0 --template dot_env.m4 --repository rotheross --tag latest-11_0
    $0 --template dot_env.m4 --repository rotheross --tag devel-rel-11_0

    # specify the empty string for locally build images
    $0 --template dot_env.m4 --repository "" --tag local-11.0.x

    # specify a project when having to switch between different projects
    $0 --template dot_env.m4 --repository "" --tag local-11.0.x --project otobo-ACME
