...
m4_define(`otovar_DEFAULT_TAG',`latest-11_0')
...
# More examples
#OTOBO_IMAGE_OTOBO=rotheross/otobo:rel-11_0_1
...
# More examples
#OTOBO_IMAGE_OTOBO_ELASTICSEARCH=rotheross/otobo-elasticsearch:rel-11_0_1
...
# More examples
`#'OTOBO_IMAGE_OTOBO_NGINX=rotheross/otovar_NGINX_IMAGE():rel-11_0_1
...
# More examples
`#'OTOBO_IMAGE_OTOBO_SELENIUM_CHROME=rotheross/otobo-selenium-chrome:rel-11_0_1
